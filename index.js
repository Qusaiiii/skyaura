	...
	switch (baseCommand) {
		...
		case 'player':
			if (commandArgs.length > 0) {
				...
				playerRich.setFooter('SkyAura Bot | Created by ethanent', 'https://i.imgur.com/hFbNBr5.jpg')
		...
		case 'guild':
			if (commandArgs.length > 0) {
				...
				guildRich.setFooter('SkyAura Bot | Created by ethanent', 'https://i.imgur.com/hFbNBr5.jpg')
